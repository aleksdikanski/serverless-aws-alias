...
const apiGatewayV2 = require('./stackops/apiGatewayV2');
...
module.exports = {
	...
	aliasHandleApiGatewayV2(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		return apiGatewayV2.call(this, currentTemplate, aliasStackTemplates, currentAliasStackTemplate);
	},
	...
	aliasRestructureStack(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		...
		.spread(this.aliasHandleApiGatewayV2)
